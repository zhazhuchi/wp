...
var Promise = (function() {
    ...
    /**
     * 构造promise
     * @param {Function} resolver 立即执行函数
     * @constructor
     */
     ...
     * @param {Object} promise promise对象
     * @param {Object} x promise2
     * @param {Object} resolve 成功处理
     * @param {Object} reject 失败处理
     * @return {Object} 决定是否继续
     */
     ...
     * @param {Function} resolver 一个立即执行函数
     * @return {Object} promise
     */
